    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 space-y-6">
        <div class="flex flex-wrap items-start justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                @if ($canEdit)
                    <x-button href="{{ route('admin.subscription-plans.edit', $plan) }}" wire:navigate>
                        Edit plan
                    </x-button>
                @endif
            </div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 pt-6 space-y-4">
            ...
            <dl class="grid gap-4 sm:grid-cols-2">
                <div>
                    <dt class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">Max users per {{ entity_label() }}</dt>
                    <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">
